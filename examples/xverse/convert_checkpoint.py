...
from tensorrt_llm.models import XverseConfig, XverseForCausalLM
from tensorrt_llm.models.xverse.convert import (load_hf_xverse,
...
def convert_and_save_hf(args):
    ...
    if args.smoothquant is not None or args.int8_kv_cache:
        ...
        XverseForCausalLM.quantize(args.model_dir,
                                  args.output_dir,
                                  dtype=args.dtype,
                                  mapping=mapping,
        ...
        hf_model = load_hf_xverse(model_dir, load_model_on_cpu)
        ...
        def convert_and_save_rank(args, rank):
            mapping = Mapping(world_size=world_size,
                              ...
                              moe_tp_size=args.moe_tp_size,
                              moe_ep_size=args.moe_ep_size)
            xverse = XverseForCausalLM.from_hugging_face(
            ...
            xverse.save_checkpoint(args.output_dir, save_config=(rank == 0))
            del xverse
...
def convert_and_save_gptq(args, rank):
    mapping = Mapping(world_size=args.tp_size * args.pp_size,
                      ...
                      rank=rank,
                      pp_size=args.pp_size)
    config = XverseConfig.from_hugging_face(
        args.model_dir,
        args.dtype,
        mapping=mapping,
        quant_config=args_to_quant_config(args),
